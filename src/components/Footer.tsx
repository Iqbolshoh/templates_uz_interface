        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              <img src="/assets/images/logo_2.png" className="w-12 h-12 bg-white rounded-lg" alt="Logo" />
              <span className="font-heading font-bold text-xl">Templates.uz</span>
            </Link>
          ...
          {/* Main Links */}
          <div>
            <h5 className="font-heading font-semibold text-white mb-4 relative">
              Havolalar
              <span className="absolute bottom-0 left-0 w-12 h-0.5 bg-primary rounded"></span>
            </h5>
              ...
              {footerLinks.main.map((link, index) => (
                <li key={index}>
                  {link.href.startsWith('/') ? (
                    <Link
                      to={link.href}
                      className="text-gray-300 hover:text-primary hover:pl-2 transition-all duration-300 text-sm block"
                    >
                      {link.label}
                    </Link>
                  ) : (
          ...
          <div>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center space-x-3 group">
                ...
                <a href="mailto:support@templates.uz" className="text-gray-300 hover:text-primary transition-colors text-sm">
              ...
              <div className="flex items-center space-x-3 group">
                ...
                <a href="tel:+998997799333" className="text-gray-300 hover:text-primary transition-colors text-sm">
                  +998 99 779 93 33
                </a>
              </div>
            </div>
