            ...
            <div className="flex space-x-3">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className={`w-10 h-10 bg-gradient-to-br ${social.gradient} rounded-xl flex items-center justify-center text-white hover:scale-110 hover:shadow-glow-red transition-all duration-300 group`}
                  title={social.name}
                >
