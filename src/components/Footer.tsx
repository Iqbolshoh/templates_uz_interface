...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/iqbolshoh_777',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/iqbolshoh',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/in/iqbolshoh',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-primary-500/10 to-blue-600/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-tl from-purple-500/10 to-pink-600/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="flex space-x-3">
              {socialLinks.map((social, index) => (
                <a
                  ...
                  className={`w-10 h-10 bg-gradient-to-br ${social.gradient} rounded-xl flex items-center justify-center text-white hover:scale-110 hover:shadow-lg transition-all duration-300 group`}
                  title={social.name}
                >
          ...
          {/* Main Links */}
          <div>
            <h5 className="font-heading font-bold text-white mb-6 relative">
              ...
              {footerLinks.main.map((link, index) => (
                <li key={index}>
                  {link.href.startsWith('/') ? (
                    <Link
                      to={link.href}
                      className="text-gray-300 hover:text-white hover:translate-x-2 transition-all duration-300 text-sm block group"
                    >
          ...
          <div>
            <h5 className="font-heading font-bold text-white mb-6 relative">
              ...
              <div className="absolute bottom-0 left-0 w-12 h-1 bg-gradient-to-r from-green-500 to-teal-600 rounded-full"></div>
            </h5>
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center space-x-3 group">
                ...
                <a href="mailto:support@templates.uz" className="text-gray-300 hover:text-white transition-colors text-sm">
              ...
              <div className="flex items-center space-x-3 group">
                ...
                <a href="tel:+998997799333" className="text-gray-300 hover:text-white transition-colors text-sm">
                  +998 99 779 93 33
                </a>
              </div>
            </div>
            ...
            {/* Newsletter Signup */}
            <div className="bg-gradient-to-br from-gray-800/50 to-gray-700/50 rounded-2xl p-4 border border-gray-700">
              <h6 className="font-semibold text-white mb-2 text-sm">Yangiliklar</h6>
              <p className="text-gray-400 text-xs mb-3">Eng so'nggi yangiliklar va takliflardan xabardor bo'ling</p>
              <div className="flex">
                <input
                  type="email"
                  placeholder="Email manzilingiz"
                  className="flex-1 px-3 py-2 bg-gray-700 text-white text-xs rounded-l-lg border border-gray-600 focus:border-primary-500 focus:outline-none"
                />
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400 text-sm">Onlayn</span>
              </div>
            </div>
          </div>
        </div>
